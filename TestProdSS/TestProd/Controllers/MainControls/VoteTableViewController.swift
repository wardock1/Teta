...
class VoteTableViewController: UITableViewController {
	...
	override func viewDidLoad() {
		...
		//		voteList.append(VoteData(question: "Были ли случаи опоздания на работу ?", firstAnswer: "Да", secondAnswer: "Нет", thirdAnswer: ""))
		//		voteList.append(VoteData(question: "Как часто? (если были)", firstAnswer: "Несколько раз в месяц", secondAnswer: "Несколько раз в неделю", thirdAnswer: ""))
		//		voteList.append(VoteData(question: "Был замечен в нетрезвом состоянии ?", firstAnswer: "Редко", secondAnswer: "Часто", thirdAnswer: ""))
		//		voteList.append(VoteData(question: "Уходит с работы по личным причинам ?", firstAnswer: "Да, предупреждает.", secondAnswer: "Да, не предупреждает.", thirdAnswer: "Нет"))
		//		voteList.append(VoteData(question: "Как часто ? (если уходит)", firstAnswer: "Несколько раз в неделю.", secondAnswer: "Несколько раз в месяц.", thirdAnswer: ""))
		//		voteList.append(VoteData(question: "Соблюдает вежливость в общении с коллегами ?", firstAnswer: "Да, со всеми", secondAnswer: "Нет, не со всеми", thirdAnswer: ""))
		//		voteList.append(VoteData(question: "Допускает провокационные ситуации?", firstAnswer: "Да", secondAnswer: "Нет", thirdAnswer: ""))
		loadQuestion()
	}
...
extension VoteTableViewController: Responsable {
	func responsable(for index: Int, with response: Int, and question: Question) {
		...
		print("also2: \(question.answers[response].response)")
	}
}
